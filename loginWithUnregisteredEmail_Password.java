...
public class loginWithUnregisteredEmail_Password {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.name("email")).sendKeys("Saket123@gmail.com");
        driver.findElement(By.name("password")).click();
        driver.findElement(By.name("password")).sendKeys("Saket@");
